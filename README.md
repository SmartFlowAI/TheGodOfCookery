...
- [2024.2.22] 基于团队成员 @房生亮 的Stabble Diffsion模型 以及 @solo fish 的 语音输入模型，整合 text2image分支，发布1阶段第一个版本应用 [openxlab app](https://openxlab.org.cn/apps/detail/zhanghui-china/nlp_shishen3)
- [2024.2.22] 基于团队成员 @Charles 的RAG模块(Chroma)，整合 text2image分支，发布二阶段第2个版本应用 [openxlab app](https://openxlab.org.cn/apps/detail/zhanghui-china/nlp_shishen3)
