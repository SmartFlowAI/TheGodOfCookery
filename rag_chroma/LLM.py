...
import torch
from rag_chroma.interface import GenerationConfig, generate_interactive
from app import combine_history
...
class CookMasterLLM(LLM):
    ...
    def _call(self, prompt: str, stop: Optional[List[str]] = None,
        ...
        max_length=2048, top_p=0.8, temperature=0.8, repetition_penalty=1.002)   #InternLM2
        generator = generate_interactive(
                    model=self.model,
                    tokenizer=self.tokenizer,
                    prompt=combine_history(prompt),
